...
namespace BorrowedGames.Helpers
{
    public class Guard
    {
        public static void ForValidId(string propName, Guid id)
        {
            ForValidId(id, propName + " is not a valid ID");
        }
        ...
        public static void ForNegative(string propName, int number)
        {
            if (number < 0)
                throw new Exception(propName + " can not be negative");
        }

        public static void ForNullOrEmptyDefaultMessage(string propName, string value)
        {
        ...
        {
            StringLength(stringValue, maximum, propName + " can't be longer than " + maximum + " characters");
        }
        ...
        {
            StringLength(stringValue, minimum, maximum, propName + " must contain between " + minimum + " and " + maximum + " characters");
        }
